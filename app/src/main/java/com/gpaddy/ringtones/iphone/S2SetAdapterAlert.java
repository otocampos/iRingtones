...
public class S2SetAdapterAlert extends ArrayAdapter {
    ...
    public S2SetAdapterAlert(Activity context, int layoutID, ArrayList<S1ObjectMusic> arrayObjects) {
    ...
    public View getView (final int position, View convertView, ViewGroup parent) {
            ...
            public void onClick(View v) {
                ...
                if (recentIndex == position) {
                    if (arrayObjects.get(recentIndex).isStatus()) {
                        ...
                        mediaPlayer = MediaPlayer.create(context, Uri.parse(Environment.getExternalStorageDirectory().getPath() + "/i Alert/" + name + ".mp3"));
                        mediaPlayer.start();
        ...
        buttonSet.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final File file = new File(Environment.getExternalStorageDirectory().getPath() + "/i Alert/", name + ".mp3");
